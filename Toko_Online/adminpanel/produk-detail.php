        ...
        <div class="col-12 col-md-6 mb-5">
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div>
                    ...
                    <input type="number" name="harga" id="harga" value="<?php echo $data['harga'] ?>" class="form-control" autocomplete="off" required>
                </div>
                <div>
                ...
                <div>
                    <label for="foto">Foto (Maks 5 Mb), Format (jpg/png/gif)</label>
